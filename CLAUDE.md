...
2. ファイル名: `commitlog-YYYYMMDDHHMM.md`（例: `commitlog-202412232150.md`）
3. 前回からの変更内容を確認する方法:
   - `git diff HEAD~1` または `git log` でコードの変更を確認
   - `/commit_log` 内の最新のログファイルを参照して前回の状態を把握
4. 内容に含めるもの:
   - 更新日時
   - 変更したファイル一覧
